<template>
    <div>
        ...
        <div style="display: block; margin-top:10px ;">
            <el-upload
                    action="http://localhost:9090/carousel/upload"
        ...
        <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">>
            ...
            <el-table-column prop="name" label="轮播图名称" width="80" align="center"></el-table-column>
            <el-table-column prop="content" label="图片概述" width="200" align="center"></el-table-column>
            <el-table-column prop="url" label="指向地址" width="80" align="center"></el-table-column>
            <el-table-column prop="user" label="上传用户" width="80" align="center"></el-table-column>
            <el-table-column prop="time" label="上传时间" width="80" align="center"></el-table-column>
...
<!--弹窗-->
        ...
        <el-dialog title="轮播图内容" :visible.sync="dialogFormVisible" width="30%"  >
            <el-form label-width="80px"   ref="form" :model="form" width="200px" style="height: 100px">
...
<script>
    ...
    export default {
        ...
        methods:{
            handleSave(){
                this.request.post("/carousel/update",this.form).then(res =>{
                    if(res){
            ...
            changeEnable(row) {
                this.request.post("/carousel/update", row).then(res => {
                    if (res.code === '200') {
