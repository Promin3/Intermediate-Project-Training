<template>
    <div>
        ...
        <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">>
            ...
            <el-table-column prop="id" label="收藏ID" width="120"></el-table-column>
        ...
        <el-dialog title="评论信息" :visible.sync="dialogFormVisible" width="30%">
            ...
            <el-form-item label="作者ID" >
                <el-input v-model="form.authorid" autocomplete="off"></el-input>
            </el-form-item>
        </el-form>
...
import {Axios as request} from "axios";
    export default {
        ...
        methods:{
            load(){
                this.request.get( "http://localhost:9090/collection/page",{
                    params: {
            ...
            handleDelete(id){
                this.request.delete("http://localhost:9090/collection/"+id).then(res =>{
                    if(res){
            ...
            handleSave(){
                this.request.post("http://localhost:9090/collection",this.form).then(res =>{
                    if(res){
            ...
            delBatch(){
                ...
                this.request.post("http://localhost:9090/collection/del/batch",ids).then(res=>{
                    if(res){
