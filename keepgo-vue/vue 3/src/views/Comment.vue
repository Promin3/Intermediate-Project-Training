<template>
    <div>
        <div style="padding: 5px 0;text-align:left">
            <el-input style="width: 200px" placeholder="请输入评论内容" suffix-icon="el-icon-search" v-model="articleId"></el-input>
        ...
        <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">>
            ...
            <el-table-column prop="content" label="评论内容" width="350"></el-table-column>
            <el-table-column prop="userId" label="评论人ID" width="80"></el-table-column>
            <el-table-column prop="time" label="评论时间"></el-table-column>
            <el-table-column  prop="articleId" label="关联文章的ID"></el-table-column>
            <el-table-column>
...
import {Axios as request} from "axios";
    export default {
        ...
        methods:{
            load(){
                this.request.get( "http://localhost:9090/comment/Bpage",{
                    params: {
            ...
            handleSave(){
                this.request.post("http://localhost:9090/comment",this.form).then(res =>{
                    if(res){
