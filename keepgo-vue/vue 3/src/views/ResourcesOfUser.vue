<!-- <template>
    <div>
        ...
        <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">>
            ...
            <el-table-column prop="userid" label="上传者id" width="80" align="center"></el-table-column>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            handleDelete(id){
                this.request.delete("/resources/"+id).then(res =>{
                    if(res){
            ...
            delBatch(){
                ...
                this.request.post("/resources/del/batch",ids).then(res=>{
                    if(res){
            ...
            changeEnable(row) {
                this.request.post("/resources/update", row).then(res => {
                    if (res.code === '200') {
