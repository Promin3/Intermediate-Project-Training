<template>
    <div style="background-color: #ffffff">
        ...
        <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">>
            ...
            <el-table-column prop="summary" label="文章概述" width="200" align="center"></el-table-column>
            <el-table-column prop="content" label="文章预览" width="200" align="center">
            ...
            <el-table-column label="操作"  align="center">
                ...
                <template slot-scope="scope">
                    <el-button type="warning" @click="handleEdit(scope.row)">修改<i class="el-icon-edit" ></i></el-button>
                    <el-popconfirm
                            confirm-button-text='确定'
                            cancel-button-text='我再想想'
                            icon="el-icon-info"
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            load(){
                this.request.get("/article/page/personalArticle",{
                    params: {
